			...
			"CPU": {
				...
				Items: []model.Item{
					...
					},
					{
						...
						Price: currency.EUR.Amount(192.88),
				...
				Items: []model.Item{
					{
						...
						Price: currency.EUR.Amount(389.90),
					...
					},
					{
						...
						Price: currency.EUR.Amount(369.8),
					...
					},
					{
						...
						Price: currency.EUR.Amount(234.89),
					...
					},
					{
						...
						Price: currency.EUR.Amount(77.95),
					...
					},
					{
						...
						Price: currency.EUR.Amount(319.99),
					...
					},
					{
						...
						Price: currency.EUR.Amount(109.99),
					...
					},
					{
						...
						Price: currency.EUR.Amount(369.99),
				...
				Items: []model.Item{
					{
						...
						Price: currency.EUR.Amount(22.99),
					},
					{
					...
					},
					{
						...
						Price: currency.EUR.Amount(35.99),
					},
					{
						...
						Price: currency.EUR.Amount(15.99),
					},
					{
					...
					},
					{
						...
						Price: currency.EUR.Amount(14.99),
					},
					{
						...
						Price: currency.EUR.Amount(15.29),
					},
					{
						...
						Price: currency.EUR.Amount(26.99),
					},
					{
						...
						Price: currency.EUR.Amount(8.39),
					},
					{
						Name:  "Cable Ethernet 5m Cat 7, Cable RJ45 Blindé Haute Vitesse 10Gbit/s 600MHz S/FTP Câble Réseau Blanc Gigabit Extérieur Imperméable Câble LAN Câble Internet pour Routeur Switch Modem PS5/4",
						URL:   "https://amzn.to/4bayN5y",
						Price: currency.EUR.Amount(11.99),
					},
				},
			},
		},
...
func main() {
	...
	if certPath != "" && certificateKeyPath != "" {
